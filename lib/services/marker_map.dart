...
Future<ui.Image> getImageFromPath(Uint8List imageBytes) async {
...
Future<BitmapDescriptor> getMarkerIcon(
    Uint8List uint8listimage, Size size) async {
  ...
  // Add image
  ui.Image image = await getImageFromPath(uint8listimage);
